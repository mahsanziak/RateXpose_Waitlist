...
const Home: NextPage = () => {
  return (
    <div className="bg-black text-white min-h-screen flex flex-col items-center px-4">
      ...
      <header className="flex justify-between items-center w-full p-4 max-w-6xl">
      ...
      <main className="flex flex-col items-center mt-16 text-center max-w-6xl w-full">
        <h1 className="text-4xl md:text-6xl font-bold leading-tight">Built to power the next generation creator</h1>
